      ...
      <div className="bg-zinc-900 border-2 border-zinc-800 p-5 sm:p-10 rounded-3xl w-full max-w-md shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-4xl font-black text-white tracking-tighter italic">
              ENTER <span className="text-blue-500 underline decoration-blue-500/30 underline-offset-8">LOBBY</span>
            </h2>
        ...
        <Link 
          to="/" 
          className=" mt-5 text-gray-400 hover:text-white flex items-center gap-2 transition-colors"
        >
          <ArrowLeft size={20} />
